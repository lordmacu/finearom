<x-admin.wrapper>
    <x-slot name="title">
        {{ __('Agregar Sucursal para el Cliente: ') . $client->client_name }}
    </x-slot>
    ...
    <div class="w-full py-2 overflow-hidden">
        <form method="POST" action="{{ route('admin.branch_offices.store', $client->id) }}">
            @csrf
            ...
            <div class="cont-form">
                <div class="flex gap-4">
                    ...
                    <div class="w-1/2">
                        ...
                        <x-admin.form.input id="nit" class="{{ $errors->has('nit') ? 'border-red-400' : '' }}"
                            type="text" name="nit" value="{{ old('nit') }}" />
                    </div>
                </div>
                ...
                <div class="py-2">
                    ...
                    <x-admin.form.input id="general_observations"
                        ...
                        name="general_observations" value="{{ old('general_observations') }}" />
                </div>
            </div>
