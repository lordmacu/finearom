<x-admin.wrapper>
    ...
    <div class="d-print-none with-border">
        <x-admin.breadcrumb href="{{route('admin.user.index')}}" title="{{ __('View user') }}"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
