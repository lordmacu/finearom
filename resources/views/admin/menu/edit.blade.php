<x-admin.wrapper>
    ...
    <div>
        <x-admin.breadcrumb href="{{route('admin.menu.index')}}" title="{{ __('Actualizar Menú') }}">
    ...
    <div class="w-full py-2 overflow-hidden cont-form">
        ...
        @method('PUT')
            ...
            <div class="py-2">
                <x-admin.form.label for="machine_name">{{ __('Nombre de Máquina:') }} {{ $menu->machine_name }}</x-admin.form.label>
            </div>
