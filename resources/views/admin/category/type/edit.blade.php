<x-admin.wrapper>
    ...
    <div>
        <x-admin.breadcrumb href="{{route('admin.category.type.index')}}" title="{{ __('Update Category Type') }}"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
