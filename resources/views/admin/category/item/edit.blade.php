<x-admin.wrapper>
    ...
    <div>
        <x-admin.breadcrumb href="{{route('admin.category.type.item.index', $type->id)}}" title="{{ __('Actualizar categoría') }}">
    ...
    <div class="w-full py-2 overflow-hidden">
        ...
        @method('PUT')
            ...
            <div class="py">
                ...
                <div>
                    La profundidad máxima para un enlace y todos sus hijos es fija. Algunos enlaces de tipo pueden no estar disponibles como padres si seleccionarlos excede este límite.
                </div>
            </div>
